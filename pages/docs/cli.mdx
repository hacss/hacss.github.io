...
<Article
  ...
  subtitle="A quick and simple way to start using Hacss">
...
If you would like to extend the capabilities of Hacss as described
[here](./post-processing), you can pipe the output of Hacss to
[PostCSS](https://postcss.org). For example:
