...
capabilities that normally require external style sheets: selectors, variables
(named constants), and media queries.
...
constraints upon your design by supporting a wide array of HTML templating
