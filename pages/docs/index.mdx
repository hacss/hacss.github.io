...
To get a small taste of what Hacss can do, you can try the Hacss CLI with no
installation required using [`npx`](https://docs.npmjs.com/cli/v7/commands/npx):

<ShellCommand>echo ":hover{`{color:red}`}" | npx hacss</ShellCommand>
