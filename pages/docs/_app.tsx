...
= ({ pathname, sidebarState, onSidebarOpen, onSidebarClose, onSidebarLinkClick, children }) => {
  ...
  return (
    <div className="display:flex; height:100%;">
      <header className={`
        ${animations ? "animations" : "no-animations"}
        sidebar
        ${sidebarState}
        background:$gray90;
        ...
        position:relative;
        .no-animations_{transition:none}!
      `}>
        <div className={`
          display:flex;
          align-items:center;
              ...
              `}>
                <defs>
                  <linearGradient id="logoB" x1="0" x2="0" y1="0" y2="100%">
                    <stop offset="62.5%" className="stop-color:$gray10; .link:hover_{stop-color:$blue10} .link:active_{stop-color:$red10} transition-property:stop-color; transition-duration:250ms; .no-animations_{transition:none}!"></stop>
                    <stop offset="62.5%" className="stop-color:$gray30; .link:hover_{stop-color:$blue30} .link:active_{stop-color:$red30} transition-property:stop-color; transition-duration:250ms; .no-animations_{transition:none}!"></stop>
                  </linearGradient>
                  <linearGradient id="logoA" x1="0" x2="0" y1="0" y2="100%">
                    <stop offset="50%" className="stop-color:$gray10; .link:hover_{stop-color:$blue10} .link:active_{stop-color:$red10} transition-property:stop-color; transition-duration:250ms; .no-animations_{transition:none}!"></stop>
                    <stop offset="50%" className="stop-color:$gray30; .link:hover_{stop-color:$blue30} .link:active_{stop-color:$red30} transition-property:stop-color; transition-duration:250ms; .no-animations_{transition:none}!"></stop>
                  </linearGradient>
                </defs>
                <path
                  className="transition-property:transform; transition-duration:250ms; .no-animations_{transition:none}! .sidebar.animations:not(.open)_{transform:scale(0.75)__translate(3.75%,15%)}"
                  fill="url(#logoB)"
                ...
                />
                <path
                  className=".sidebar:not(.open)_{transform:translateX(26rem)__scaleX(0)} transform-origin:left; transition-property:transform; transition-duration:250ms; .no-animations_{transition:none}! .no-animations_{transform:none}!"
                  fill="url(#logoA)"
