...
<Article
  title="Configuration"
  subtitle="Use variables and media queries throughout your site">

This guide explains how to configure Hacss to support variables
(i.e. named constants) and at-scopes (e.g. media queries).
