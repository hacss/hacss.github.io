...
const Head: FC<{ subtitle?: string, description?: string, previewImage?: string, children?: undefined }> =
  ({ subtitle, description, previewImage }) => (
    <NextHead>
      ...
      <meta property="og:image" content={previewImage || "https://repository-images.githubusercontent.com/254430836/ae9b8500-85b3-11eb-815d-058e04fcdf5a"} />
